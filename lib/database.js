...
var GetUsersForCourseQuery = 'SELECT u.id, u.fname, u.lname' +
                             ' FROM _user u, takes t' +
                             ' WHERE t.cid = $1 AND t.sid = u.id AND u.id <> $2';
var SaveResourceQuery = 'INSERT INTO File(name, course, owner, url) VALUES($1, $2, $3, $4)';
