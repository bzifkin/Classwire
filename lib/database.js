...
var ReportedContentQuery = 'select v.fname as authf, v.lname as authl, t.fname as reportf, t.lname as reportl, c.message, r.explanation'+
...
var GetFirstNameLastNameQuery = 'SELECT fname, lname FROM _user WHERE id = $1';
var GetMessageQuery = 'SELECT messsage FROM chat_messages WHERE id = $1';
...
function getReportedContent(cb){
    pg.connect(constr, (err, client, done) => {
        ...
        client.query(ReportedContentQuery, (err, result) => {
            ...
            console.log(ReportedContentQuery);
