...
var team = [
	...
	member('annecatherin', 'Catherine', 'Feldman', 'senior'),
	member('pscarfi', 'Phil', 'Scarfi', 'senior'),
	member('drabelo', 'Dailton', 'Rabelo', 'senior'),
	member('bzifkin', 'Ben', 'Zifkin', 'senior')
];
...
function copy(oldMember) {
	...
	return member(oldMember.user, oldMember.fname, oldMember.lname, oldMember.year);
}
