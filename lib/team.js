 ...
 */
function copy(copymember) {
	// TODO
	var newMember = member(copymember.user,copymember.fname, copymember.lname, copymember.year);
	return newMember;
}
...
function all() {
	// TODO
	var resultObj = result(true,'team members',copyAll(team));
...
function one(user) {
	...
	if(typeof user === "string"){
		...
		return result(false, 'internal processing issue',[]);
	}
}
