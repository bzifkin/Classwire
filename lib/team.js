...
var team = [
	...
	member('asuszek', 'Austin', 'Suszek', 'senior',
		"Austin is a senior in Computer Science at the University of Massachusetts Amherst. " +
		"Spending his days programming mobile applications when he isn't busy in class landed " +
		"him an internship at Google this past Summer. There he worked on the Youtube team adding " +
		"a feature for variable speed playback on videos. Now, on the ClassWire team, he'll be working " +
		"on the backend to deliver the finest server side this side of the Mississippi."),

	member('ndelfino', 'Nick', 'Delfino', 'senior',
		'Nick Delfino has been creating software applications since his sophomore year in High School. ' +
		'Now, as a senior at University of Massachusetts Amherst, he has expanded his knowledge and experience by ' +
		'continuing to develop mobile applications and by interning at Charles River Development. While there, ' +
		'he worked on the portfolio management user interface team to continue improving their high quality' +
		' desktop application for stock analysis. With all this experience working on user interfaces, ' +
		'Nick will be spending his time on the frontend making user interaction smooth and intuitive. ' +
		'When he isn’t programming you can find him at the nearest cinema seeing the latest films ' +
		'or guzzling chai lattes at Rao’s in town.'),

	member('annecatherin', 'Catherine', 'Feldman', 'senior','Catherine is a senior pursuing a double degree ' +
		'in Computer Science and Psychology at the University of Massachusetts Amherst. Her multidisciplinary' +
		' background led her to UX research, design and development internships at HubSpot, the MIT Media Lab, ' +
		'and a gaming research lab at Drexel University. Fun fact: she can now be found in the Scratch.mit.edu ' +
		'Sprites Library as a result of her time at the MIT Media Lab. Her talents include going unreasonable ' +
		'amounts of time without sleep, replying with on-point reaction gifs, finding super great adventure spots,' +
		' and designing and developing ballin’ software. Her weaknesses include writing bios about herself and ' +
		'deciding on which movie to watch. Catherine will be bringing her talents to the ClassWire UI.'),

	member('pscarfi', 'Phil', 'Scarfi', 'senior',
		'Phil Scarfi is a senior at the University of Massachusetts. ' +
		'He is a double major in Computer Science and Business Management. ' +
		'Phil has a passion for mobile technology, iOS applications in particular. ' +
		'He has been developing iOS applications since freshman year of college and has ' +
		'worked with many different clients including BuzzFeed, OMG Music Fest, ' +
		'UMass Amherst Dining, and many more! Being able to take an idea and turn it into ' +
		'reality is one thing that Phil loves about programming! Phil will be bringing his' +
		'talents to the server-side portion of ClassWire.'),

	
	member('drabelo', 'Dailton', 'Rabelo', 'senior',
		'Dailton is a senior in computer science at the University of Massachusettes Ahmerst. His '+
		'primary passion in CS is mobile application development. Currently he has a mobile ' +
		'development internship at IBM working remote and loves it. Dailton hopes to bring his ' + 
		'experiene with mobile design and user experience to the front-end development of ClassWire. '),
