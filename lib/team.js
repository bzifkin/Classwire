...
var team = [
	...
	member('jdoe', 'John', 'Doe', 'senior','test desc'),
	member('asuszek', 'Austin', 'Suszek', 'senior','test desc'),
	member('ndelfino', 'Nick', 'Delfino', 'senior','test desc'),
	member('annecatherin', 'Catherine', 'Feldman', 'senior','test desc'),
	member('pscarfi', 'Phil', 'Scarfi', 'senior','test desc'),
