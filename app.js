...
app.get('/team/ndelfino', (req, res) => {
  // TODO
  var result = team.one('ndelfino');
  if (!result.success) {
    notFound404(req, res);
  } else {
    res.render('team', {
...
app.get('/team/asuszek', (req, res) => {
  // TODO
  var result = team.one('asuszek');
  if (!result.success) {
    notFound404(req, res);
  } else {
    res.render('team', {
...
app.get('/team/annecatherin', (req, res) => {
  // TODO
  var result = team.one('annecatherin');
  if (!result.success) {
    notFound404(req, res);
  } else {
    res.render('team', {
...
app.get('/team/bzifkin', (req, res) => {
  // TODO
  var result = team.one('bzifkin');
  if (!result.success) {
    notFound404(req, res);
  } else {
    res.render('team', {
...
app.get('/team/pscarfi', (req, res) => {
  // TODO
  var result = team.one('pscarfi');
  if (!result.success) {
    notFound404(req, res);
  } else {
    res.render('team', {
...
app.get('/team/drabelo', (req, res) => {
  // TODO
  var result = team.one('drabelo');
  if (!result.success) {
    notFound404(req, res);
  } else {
    res.render('team', {
